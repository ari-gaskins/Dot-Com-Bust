...
public class DotComBust {
    ...
    private void setUpGame() {
        //make 3 dot com objects, give them names, and give them locations in the ArrayList
        ...
        for (DotCom dotComToSet : dotComsList) {
            ...
            //call the setter method on this DotCom to give it the location received from helper
    ...
    private void checkUserGuess(String userGuess) {
        ...
        for (DotCom dotComToTest : dotComsList) {
            ...
            if (result.equals("kill")) {
                //the object is dead, take it out of dotComsList the get out of loop
    ...
    public static void main (String[] args) {
        ...
        //tell game object to start the main game play loop 
        game.startPlaying();
    }
}
